...
@Component({
  ...
  styleUrl: './department-position.component.css'
})


export class DepartmentPositionComponent implements OnInit {
  ...
  constructor(private EmployeeService: EmployeeService, private dialogRef: MatDialogRef<DepartmentPositionComponent>) { }
